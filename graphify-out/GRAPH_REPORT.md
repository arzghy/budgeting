...
## Corpus Check
- 232 files · ~494,826 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4244 nodes · 9717 edges · 212 communities (170 shown, 27 thin omitted)
...
Cohesion: 0.40
Nodes (3): metadata, plusJakartaSans, Providers()
...
Cohesion: 0.07
Nodes (58): buildUpdateDirective(), compareSemver(), computeUpdateDirective(), contextSourcePath(), contextSourceStatus(), DESIGN_NAMES, directChildDirs(), discoverRootsForPattern() (+50 more)
...
Cohesion: 0.15
Nodes (17): appendBuildPathDirective(), appendDetectorFallback(), automaticHookMode(), hookEnabledAt(), parseYamlFlowList(), projectRootsDiagnostic(), readBuildPathAt(), readImpeccableProjectRoots() (+9 more)
...
Cohesion: 0.21
Nodes (14): livePathGlobToRegex(), parseTargetOptions(), parseTargetPath(), TargetArgError, __dirname, ensureServerRunning(), resolveFiles(), liveCli() (+6 more)
...
Cohesion: 0.21
Nodes (14): isLiveServerPidReachable(), readLiveServerInfo(), FORBIDDEN, verifyAcceptedFile(), completeCli(), completeThroughServer(), parseArgs(), readServerInfo() (+6 more)
...
Cohesion: 0.07
Nodes (33): mergeDesignSystemFindings(), collectStaticCssText(), resolveLinkedCssPath(), checkStaticPageTypography(), detectHtml(), STATIC_ELEMENT_RULES, checkCreamPalette(), checkElementGlow() (+25 more)
...
### Community 154 - "surface-briefs.mjs"
Cohesion: 0.35
...
Cohesion: 0.18
Nodes (4): LenisProvider(), dict, WhaleScene, PALETTE
...
### Community 171 - "cli"
Cohesion: 0.11
Nodes (21): appendAutonomyCounterDirective(), appendCompRoundOpenDirective(), appendImageGenDirective(), appendImageToolsDirective(), appendSubagentAuthorizationDirective(), appendSurfaceBriefContext(), buildMissingTargetDirective(), buildResolvedContextDirective() (+13 more)
...
## Knowledge Gaps
- **927 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `@typescript-eslint/no-explicit-any`, `HERE`, `STATE_PATH` (+922 more)
...
- **Why does `loadContext()` connect `cli` to `hook-before-edit.mjs`, `doctor.mjs`, `context.mjs`, `surface-briefs.mjs`, `context-signals.mjs`, `live-server.mjs`, `hook-lib.mjs`?**
